...
//
// STILL NOT CONFIRMED:
//   1. The token endpoint's own path (STORTRACK_TOKEN_PATH below is a placeholder guess —
//      '/oauth/token' is the most common convention for this exact flow, but CONFIRM against the
//      docs' own heading/example for "receives your username & password" before relying on it).
...
const TOKEN_PATH = process.env.STORTRACK_TOKEN_PATH || '/oauth/token'; // UNCONFIRMED — see header comment
