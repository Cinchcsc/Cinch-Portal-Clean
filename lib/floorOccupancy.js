...
export async function getFloorOccupancy() {
  ...
  if (!rows.length) return { generated_at: new Date().toISOString(), sites: [], floors: [], site_floors: {} };
  ...
  return { generated_at: new Date().toISOString(), sites: sitesCovered, floors, site_floors: siteFloors };
}
